...
test('P10E uses real current/next MIP1/RIP1 authority, bounded client ingress, a live driver, and pinned image provenance', () => {
  ...
  assert.match(launcher, /\$SurvivalXNodeCommit = 'a68a4cb64d2030beb8afbd9c9d73aa31dd21bd64'/);
  ...
  assert.match(compose, /XNODE_REVISION: a68a4cb64d2030beb8afbd9c9d73aa31dd21bd64/);
