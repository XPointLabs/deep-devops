# UAT BLS12-381 Prepared Registrations

Last updated for active UAT registrations on 2026-06-20.
...
`exit-requested` state. The active UAT nodes are contract IDs 4, 5, and 6 and
use the Ed25519 service-node pubkeys below.
...
Query the live prepared registration payloads:

```powershell
Invoke-RestMethod http://192.168.1.44:28082/registrations/0xb0cE3b1229c00d1B85c7083E31Dae531f3B352C0
```

The live payload includes the current BLS12-381 public key and
...
ed25519PrivateSeed: 7d9cf7783da190b89ce4c91394dd2bca4cd0817ca596ccc8fa03c565b72fa87f
activeContractId: 4
blsPrivateScalar: 27c2eb7628d717c40af80eb1ebb5821a5ac8b08f7505373d61b3ba74b2b6ae4e
...
ed25519PrivateSeed: b8dc649369037d0bdc5539bf716790eb87c83b480de0c5aaa30ab157a2c25bf2
activeContractId: 5
blsPrivateScalar: 71ab7c8130b420da63d3b3346caeea57da64edb53130e76a8a2f703d0c32000d
...
ed25519PrivateSeed: e969d23a0154523e184529709ae2fc2a2a41c0eec90ff252c81ee099ea7df26b
activeContractId: 6
blsPrivateScalar: 664eb4f0ee75ac048c9b2f038ee3727ce2cf587a76d750731c1051fb449a79bc
